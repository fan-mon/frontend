...
const CartList = () => {
    ...
    function CartList(){
        ...
        // const { orders, setOrders, ordersDetailList, setOrdersDetailList, user, setUser } = useContext(CartProvider);
        // orders = {
        //     ordersuuid: ordersuuid, //UUID
        //     address: ordersaddress, //주소
        //     createdat: orderscreatedat, //구매일자
        //     status: ordersstatus,   // 결제 단계라고 보시면 됩니다.. 옙.
        //     totalcost: finalAmount,  // 결제 예정 금액 (배송비가 포함된 총액)
        //     useruuid: ordersuseruuid,  // 로그인된 사용자의 UUID
        //     qty: totalQuantity  // 장바구니에 담긴 총 상품 수량
        //     // ,postcode: orderspostcode //우편번호
        // };

        // ordersDetailList = clist.map(crecord => ({
        //     ordersdetailuuid: ordersdetailuuid, //UUID
        //     qty: crecord.qty,  // 각 상품의 수량
        //     totalcost: crecord.goods.price * crecord.qty,  // 각 상품의 총 금액
        //     goodsuuid: crecord.goods.goodsuuid,  // 각 상품의 UUI
        //     ordersuuid : ordersdetailordersuuid, 
        //     useruuid : ordersdetailorderuseruuid
        // }));

        // user = {
        //     useruuid: useruuid, //유저 UUID
        //     address: useraddress, //유저 주소
        //     email: email,   //유저 이메일
        //     name: username, //유저 이름
        //     phone: phone    //유저 연락처
        //     // ,postcode: userpostcode //우편번호
        // };
